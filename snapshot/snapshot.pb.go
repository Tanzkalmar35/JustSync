...
type Chunk struct {
	...
	Hash   []byte `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`      // Chunk hash
	Size   int64  `protobuf:"varint,2,opt,name=size,proto3" json:"size,omitempty"`     // Chunk size (Using CDC - Content defined chunking)
	Offset int64  `protobuf:"varint,3,opt,name=offset,proto3" json:"offset,omitempty"` // The chunk's offset in file
}
...
var file_snapshot_snapshot_proto_rawDesc = []byte{
	...
	0x6b, 0x52, 0x06, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x22, 0x47, 0x0a, 0x05, 0x43, 0x68, 0x75,
	...
	0x65, 0x74, 0x22, 0xd5, 0x01, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x53, 0x6e,
	...
	0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e,
	0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x1a, 0x4e, 0x0a, 0x0a, 0x46, 0x69,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x6e, 0x61, 0x70,
	0x73, 0x68, 0x6f, 0x74, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x54, 0x0a, 0x08, 0x46, 0x69,
	0x6c, 0x65, 0x53, 0x79, 0x6e, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01,
	...
	,
...
var file_snapshot_snapshot_proto_goTypes = []interface{}{
	...
	(*Chunk)(nil),           // 1: snapshot.Chunk
	(*ProjectSnapshot)(nil), // 2: snapshot.ProjectSnapshot
	(*FileSync)(nil),        // 3: snapshot.FileSync
	(*SyncFileMessage)(nil), // 4: snapshot.SyncFileMessage
	nil,                     // 5: snapshot.ProjectSnapshot.FilesEntry
}
var file_snapshot_snapshot_proto_depIdxs = []int32{
	1, // 0: snapshot.FileChunks.chunks:type_name -> snapshot.Chunk
	5, // 1: snapshot.ProjectSnapshot.files:type_name -> snapshot.ProjectSnapshot.FilesEntry
	3, // 2: snapshot.SyncFileMessage.file:type_name -> snapshot.FileSync
	0, // 3: snapshot.ProjectSnapshot.FilesEntry.value:type_name -> snapshot.FileChunks
